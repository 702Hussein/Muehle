...
public class MultiPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
		...
		try {
			...
			players[0] = new Player(intent.getStringExtra("USER_NAME"));
			players[1] = new Player(intent.getStringExtra("USER_NAME2"));
			...
			//endregion
			Toast.makeText(MultiPlayerActivity.this, "Welcome " +players[0].getName(), Toast.LENGTH_SHORT).show();
			Toast.makeText(MultiPlayerActivity.this,  players[0].getName() + " vs " + players[1].getName(), Toast.LENGTH_LONG).show();
		} catch (Exception exc) {
